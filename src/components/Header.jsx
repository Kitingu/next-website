...
function Header({ scrollToSection }) {
	...
	return (
		<header className="bg-protoblue fixed w-full top-0 z-50 shadow-md">
			{/* Top nav */}
			<nav className="mx-auto flex container items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
				...
				<div className="hidden lg:flex lg:gap-x-10">
					{[
						...
						{ label: "Cylinders", id: "domestic" },
						{ label: "Bulk LPG", id: "bulk" },
						{ label: "Otogas", id: "otogas" },
						{ label: "ESG", id: "esg" },
					...
					<Link href="/manufacturing" className="text-sm font-semibold text-white hover:underline">
						Manufacturing
					</Link>
					<Link href="/feedback" className="text-sm font-semibold text-white hover:underline">
						Feedback
					</Link>
				</div>
			</nav>
						...
						<ul className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
							<li>
								<a href="https://www.instagram.com/seagasltd/">
									...
									<svg className="h-4 w-4" fill="white" viewBox="0 0 9 18">
										<path d="m8.346 9.737.377-2.905H5.846V4.978c0-.842.232-1.415 1.44-1.415l1.535-.001V.964A20.61 20.61 0 0 0 6.582.85c-2.218 0-3.736 1.355-3.736 3.84v2.142H.336v2.905h2.51v7.453h3V9.737h2.5Z" />
									</svg>
								</a>
							</li>
							<li>
							...
							<li>
								...
								>
									...
									<svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24">
										<path d="M20.452 20.452h-3.755v-5.569c0-1.327-.026-3.036-1.852-3.036-1.854 0-2.14 1.448-2.14 2.943v5.662H8.947V9h3.601v1.561h.051c.5-.949 1.721-1.951 3.545-1.951 3.796 0 4.494 2.5 4.494 5.747v6.095zM5.337 7.433c-1.209 0-2.189-.98-2.189-2.188 0-1.21.98-2.189 2.189-2.189s2.188.979 2.188 2.189c0 1.208-.98 2.188-2.188 2.188zM7.119 20.452H3.555V9h3.564v11.452z" />
									</svg>
								</a>
							</li>
							<li>
								<a href="tel:0800723666" className="flex items-center space-x-1 text-white">
			...
			{/* Mobile Menu */}
			{headerOpen && (
				<div className="lg:hidden absolute top-full left-0 w-full bg-white shadow-md p-6 z-40 transition-all duration-300">
