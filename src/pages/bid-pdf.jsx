...
function AnnouncementCard() {
	return (
		<div className="mt-32  rounded-xl border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-black/5 sm:p-6">
			{/* left accent */}
			<span
				className="absolute inset-y-0 left-0 w-1 bg-protopink"
				aria-hidden="true"
			/>
			<div className="relative">
				...
				<p className="mt-2 text-sm leading-6 text-slate-700">
					...
					(Assets). The Assets shall be sold on an &quot;AS IS WHERE IS&quot;
					basis. All interested bidders are requested to view the Assets at the
					locations indicated from <strong>25th August 2025</strong> to{" "}
					<strong>5th September 2025</strong> between{" "}
					<strong>08:00am to 05:00pm</strong>.
				</p>
				<p className="mt-3 text-sm leading-6 text-slate-700">
					In order to participate in this exercise, Prospective Bidders MUST pay
					a non-refundable fee of <strong>KES 10,000</strong> payable via{" "}
					<strong>Paybill Number: 247247</strong> Account Number:{" "}
					<strong>1560272926143</strong> and a copy of the payment receipt
					attached to the Bidding Document.
				</p>
				<p className="mt-3 text-sm leading-6 text-slate-700">
					Prospective Bidders are requested to submit their bids and all other
					requirements set out in the Bidding Documents electronically to{" "}
					<a
					...
					on or before <strong>11:00am on Friday 12th September 2025</strong>.
					Physical Bidding Documents are not acceptable. Bidding Documents
